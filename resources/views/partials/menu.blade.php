<div class="sidebar">
    <nav class="sidebar-nav">
        ...
        <ul class="nav">
            ...
            @endcan
            @can('college_class_access')
                <li class="nav-item">
                    <a href="{{ route("admin.college-classes.index") }}" class="nav-link {{ request()->is('admin/college-classes') || request()->is('admin/college-classes/*') ? 'active' : '' }}">
                        <i class="fa-fw fas fa-school nav-icon">

                        </i>
                        {{ trans('cruds.collegeClass.title') }}
                    </a>
                </li>
            @endcan
            @can('lesson_access')
